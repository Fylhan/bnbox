<?php
namespace Bnoger\Service\FeedWriter;
...
abstract class FeedWriter
{
     ...
     *
     * @param
     *            constant the version constant (RSS1/RSS2/ATOM).
     */
     ...
     * @access public
     * @param
     *            string name of the channel tag
     * @param
     *            string content of the channel tag
     * @return void
     */
    ...
    /**
     * Set multiple channel elements from an array.
     * Array elements
     ...
     * @access public
     * @param
     *            bool FALSE if the specific feed media type should be send.
     * @return void
     */
     ...
     * @access public
     * @param
     *            object instance of FeedItem class
     * @return void
     */
     ...
     * @access public
     * @param
     *            string value of 'title' channel tag
     * @return void
     */
     ...
     * @access public
     * @param
     *            string value of 'updated' channel tag
     * @return void
     */
     ...
     * @access public
     * @param
     *            string value of 'description' channel tag
     * @return void
     */
     ...
     * @access public
     * @param
     *            string value of 'link' channel tag
     * @return void
     */
     ...
     * @access public
     * @param
     *            string title of image
     * @param
     *            string link url of the image
     * @param
     *            string path url of the image
     * @return void
     */
    public function setImage($title, $link, $url)
    {
        $this->setChannelElement('image', array(
            'title' => $title,
            'link' => $link,
            'url' => $url
        ));
    ...
    /**
     * Set the 'about' channel element.
     * Only for RSS 1.0
     *
     * @access public
     * @param
     *            string value of 'about' channel tag
     * @return void
     */
     ...
     * @param
     *            mixed tag value as string or array of nested tags in 'tagName' => 'tagValue' format
     * @param
     *            array Attributes(if any) in 'attrName' => 'attrValue' format
     ...
     * @access private
     * @param
     *            string The vale of about tag which is used for RSS 1.0 only.
     * @return void
     */
